...
public class GameSceneManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Time.time > _next_bomb)
        {
            ...
            Bomb bomb = Instantiate(GetBombPrefab(), new Vector3(UnityEngine.Random.Range(_world_x_borders.x, _world_x_borders.y), 32f, 0f), Quaternion.identity);
        }
        ...
        if (Time.time > _next_coin)
        {
            ...
            Coin coin = Instantiate(_coin, new Vector3(UnityEngine.Random.Range(_world_x_borders.x, _world_x_borders.y), 32f, 0f), Quaternion.identity);
        }
    }
